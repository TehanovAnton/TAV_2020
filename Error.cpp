...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = // òàáëèöà îøèáîê
	{
		...
		ERROR_ENTRY(105, "îøèáêà îòêğûòèÿ ôàéëà ïğè ãåíåğàöèè êîäà (TAVasm.asm)"),
		ERROR_ENTRY(106, ""),
		ERROR_ENTRY(107, ""),
		ERROR_ENTRY(108, ""),
		ERROR_ENTRY(109, ""),
		...
		ERROR_ENTRY(112, "íå çàêğûòàÿ êàâû÷êà"),
		...
		ERROR_ENTRY(120, "íåñîîòâåòñòâèå òèïîâ îïåğàíäîâ â âûğàæåíèè"),			 // îøèáêè òèïîâ, ïåğåîïğåäåëåíèå
		...
		ERROR_ENTRY(125, "ïåğåîïğåäåëåíèå èäåíòèôèêàòîğà"),
		ERROR_ENTRY(126, ""),
		ERROR_ENTRY(127, ""),
		ERROR_ENTRY(128, ""),
		ERROR_ENTRY(129, ""),
		...
		ERROR_ENTRY(600, "íåâåğíàÿ ñòğóêòóğà ïğîãğàììû"),					// îøèáêè ñèíòàêñèñà
		...
		ERROR_ENTRY(605, "ñèíòàêñè÷åñêèé àíàëèç íå ïğîéäåí"),
